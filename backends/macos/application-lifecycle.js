...
function observeResolved(entry) {
  ...
  return {
    ...
    active:sameForeground(entry.provider, entry.identity, foreground),
    foreground,
  };
}
...
module.exports = {list, launch, activate, processCandidates, runningProcesses, resolveProvider, sameForeground};
