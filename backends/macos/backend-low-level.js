...
const PHASE10E=[
  {name:"keyboard.press",available:true,validationState:"IMPLEMENTED",strategies:["quartz-canonical-keyboard-press-post","atomic-key-lifecycle","private-native-keycodes"]},
];
