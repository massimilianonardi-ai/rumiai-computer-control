...
async function main() {
  if (process.platform !== "darwin") {
    throw new Error("The initial runtime supports the macOS transition backend only");
  }

  const backend = createLegacyMacOSBackend({
    modulePath:process.env.RUMIAI_CC_LEGACY_MODULE,
  });
